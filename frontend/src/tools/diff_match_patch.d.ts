// from https://www.npmjs.com/package/@types/diff-match-patch , MIT License
...
declare class diff_match_patch {
    ...
    ): Array<diff_match_patch.patch_obj>
    patch_make(a: diff_match_patch.Diff[]): Array<diff_match_patch.patch_obj>
    patch_make(
        a: string,
        opt_b: string,
    ...
    patch_deepCopy(
        patches: Array<diff_match_patch.patch_obj>
    ): Array<diff_match_patch.patch_obj>
    ...
    patch_addPadding(patches: Array<diff_match_patch.patch_obj>): string

    patch_splitMax(patches: Array<diff_match_patch.patch_obj>): void

    patch_fromText(text: string): Array<diff_match_patch.patch_obj>

    patch_toText(patches: Array<diff_match_patch.patch_obj>): string
...
declare const diff_match_patch_instance: diff_match_patch
export = diff_match_patch_instance
export type patch_obj = diff_match_patch.patch_obj
